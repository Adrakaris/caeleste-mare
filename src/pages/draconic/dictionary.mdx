...
Current dictionary of Draconic words in three varieties (eastern _rekharhakr_, western _rkaarik_, ancient _hakr_).

A "ditto mark" ( " ) in an entry indicates it is identical to the one left of it. 

If an entry is unfilled, it has not been finished yet. Sometimes "nf." in the notes is used to indicate this. 

Irregular verbs have conjugations shown; if a conjugation is missing from _rkaarik_, that indicates it is the same as its _rekharhakr_ counterpart. Word categories are just a rough guide and many nouns especially can be used as adjectives.
