...
The **attributor** particule *-is* is placed after a noun to signify the next phrase belongs to it in some way, which is not a strict possession. It describes the location or context of an action or noun phrase.
