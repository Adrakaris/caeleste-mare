...
| o             | /ə/ or /ↄ/             | d**o**ne or r**o**t      | x              | /ç/             | *(german)* i**ch**    |
...
> *kains* (liked) → /k<sup>h</sup>aɪnʔ/  (conjugated *s*)
> *váthas* (depths) → /vasas/ or /vasa/ or /vasa:/

### Alphabet

The draconic alphabet is called the *akron*, after its first five letters. Each letter is given a name of a word beginning with it. There is no minuscule and majuscule script.

|Letter|Name|Meaning|Letter|Name|Meaning|
|--- |--- |--- |--- |--- |--- |
|A <span class="draconic">A a</span>	|*asiir*|sun, Asyr|U	<span class="draconic">U u</span>	|*uhara*|bird|
|K <span class="draconic">K k</span>	|*kanai*|world|	X	<span class="draconic">X x</span>	|*xiron*|diamond, Xiron|
|R <span class="draconic">R r</span>	|*rekhar*|dragon|Z	<span class="draconic">Z z</span>	|*zaakos*|animal scale|
|O <span class="draconic">O o</span>	|*othalon*|wealth|Th	<span class="draconic">TH th</span>	|*thurav*|river|
|N <span class="draconic">N n</span>	|*nazar*|tithe|	M	<span class="draconic">M m</span>	|*mara*|winter|
|D <span class="draconic">D d</span>	|*drakhan*|elder|I	<span class="draconic">I i</span>	|*idiks*|species|
|E <span class="draconic">E e</span>	|*esxin*|hearth|S	<span class="draconic">S s</span>	|*serin*|shining|
|H <span class="draconic">H h</span>	|*hakr*|language|L	<span class="draconic">L l</span>	|*lovii*|animal crest|
|Kh <span class="draconic">KH kh</span>	|*kharik*|nation|P	<span class="draconic">P p</span>	|*polor*|crystal|
|V <span class="draconic">V v</span>	|*vathas*|depths|G	<span class="draconic">G g</span>	|*genisin*|birth|
|T <span class="draconic">T t</span>	|*tonis*|copper|Y	<span class="draconic">Y y</span>	|*yira*|fire|
...
> *aa triin thúrgar* — 3Pn EAT FISH — They eat fish    
> *thúrgar, aa triin* — FISH, 3Pn EAT — The fish, they ate it  
> *thúrgar triin sn* — FISH EAT BE-cop — The fish is eaten
...
> *rekhár khrae* — DRAGON RED — Red dragon
...
> *rekháridiks* — Dragonkind — lit. *rekhar* DRAGON *idiks* RACE
...
For the most part nouns can be used as adjectives to describe things that are like the noun, or of the noun. However, in some cases this may not make sense and the reverse is not true — adjectives generally cannot be used as nouns. Especially for literary reasons, “word inversion”, where a compound word is broken and the order put into head initial order is common.

> *idíks rekhár* — RACE DRAGON — dragonkind (word inverted)
...
- *aa* third person generic singular pronoun 
- *aak* third person male pronoun 
- *khaa* third person female pronoun
- *thaa* third person lower-class singular pronoun
- *saa* third person generic plural pronoun
- *thiaa* third person lower-class plural pronoun
...
> *khaaron draniir* — 3Pn-FEMALE-Poss WISDOM — Her wisdom

Adding a possessive may shift syllable stress in certain cases, such as *xíron* “Xiron” becoming *xirónon* “of Xiron”.

The **actor** particle *-ark* is placed after a verb to subjectify it into an actor of that verb. It is similar to -er in English.
...
The **negation** particle *dia* “not” can be put *before* a verb to negate it. This is often shortened to the prefix *d-*. Before certain consonants (and vowels), the *d-* prefix changes the quality of the consonant afterwards:
...
> *aak rekhár* — 3Pn-MALE DRAGON — He is a dragon 
...
> *thúrgar, aak triin sn* — FISH, 3Pn EAT Comment — The fish, they ate it
...
> *aak, aak anavín yíra* — 3Pn-MALE, 3Pn-MALE LIGHT FIRE — He who lights a fire    
> *aak, anavín yíra sn* — 3Pn-MALE, LIGHT FIRE Comment — He who lights a fire
...
> *astron arkhan, maa taikhán, lurkhái khan* — Astron LORD, Ma DUKE, Lurkhai KING — Lord Astron, Duke Ma, King Lurkhai
...
*Rkaarik* has a new sound: *xh* /ʃ/, which is represented by the digraph XH. The sounds /f/ and /v/ *are* different in speech, although still written by the same letter. 
...
The alphabet is the same, although letter names are slightly different:
...
The actor particles *-as, -ak, -ask* are all valid in place of *-ark* in *rekharhakr*.
...
> *hakr* — language — H K R [ <Drac>HKR</Drac> ] — now written H A K R [ <Drac>HAKR</Drac> ]     
> *asiir* — Asyr — A S I R [ <Drac>ASIR</Drac> ] — now written A S I I R [ <Drac>ASIIR</Drac> ]     
> *(a)srain* — to Fly — S R F N [ <Drac>SRFN</Drac> ] — now written S R A I N [ <Drac>SRAIN</Drac> ]

> *khro sar salk’ns zo dir* — A time when heaven separated from earth — Kh R | S R | S L K N S | Z | D R [ <Drac>KHR SR SLKNS Z DR</Drac> ]
